...
- [ ] 2. Implementar modelos de datos y esquema de base de datos
  - [ ] 2.1 Crear clase Post con dataclass
  ...
  - [ ]* 2.3 Escribir prueba de propiedad para mapeo de categorías
    - **Propiedad 6: Mapeo correcto de categorías**
    - **Valida: Requisitos 3.1, 3.2**
  
  - [ ]* 2.4 Escribir prueba de propiedad para categoría por defecto
    - **Propiedad 7: Categoría por defecto para tipos desconocidos**
    - **Valida: Requisitos 3.4**

- [ ] 3. Implementar capa de base de datos (Database Layer)
  - [ ] 3.1 Crear clase Database con conexión SQLite
  ...
  - [ ] 3.2 Implementar operaciones CRUD básicas
  ...
  - [ ] 3.3 Implementar operaciones de consulta
  ...
  - [ ]* 3.4 Escribir prueba de propiedad para round-trip de almacenamiento
    - **Propiedad 3: Round-trip de almacenamiento**
    - **Valida: Requisitos 2.2, 2.5**
  
  - [ ]* 3.5 Escribir prueba de propiedad para idempotencia de upsert
    - **Propiedad 4: Idempotencia de upsert**
    - **Valida: Requisitos 2.3**
  
  - [ ]* 3.6 Escribir prueba de propiedad para filtrado por categoría
    - **Propiedad 8: Filtrado por categoría**
    - **Valida: Requisitos 3.3, 4.3**
  
  - [ ]* 3.7 Escribir pruebas unitarias para casos edge de base de datos
...
- [ ] 6. Implementar capa de servicio de aplicación
  ...
  - [ ] 6.2 Implementar lógica de fetch y almacenamiento
  ...
  - [ ] 6.3 Implementar métodos de consulta
    - Implementar get_posts_by_category(category) -> List[Post]
    - Implementar get_category_statistics() -> Dict[str, int]
    - _Requisitos: 3.3, 4.3_
  
  - [ ]* 6.4 Escribir prueba de propiedad para integridad transaccional
    - **Propiedad 5: Integridad transaccional**
    - **Valida: Requisitos 6.4**
  
  - [ ]* 6.5 Escribir prueba de propiedad para evitar duplicados
    - **Propiedad 12: Evitar duplicados en actualización**
    - **Valida: Requisitos 5.2**
  
  - [ ]* 6.6 Escribir prueba de propiedad para conteo preciso
    - **Propiedad 13: Conteo preciso de posts nuevos**
    - **Valida: Requisitos 5.3**
  
  - [ ]* 6.7 Escribir prueba de propiedad para límite especificado
...
- [ ] 8. Implementar interfaz CLI
  - [ ] 8.1 Crear clase CLI con parsing de argumentos
  ...
  - [ ] 8.4 Implementar comando categories
    - Implementar handle_categories()
    - Mostrar estadísticas de posts por categoría
    - _Requisitos: 3.3_
  
  - [ ]* 8.5 Escribir prueba de propiedad para contenido de visualización
    - **Propiedad 9: Contenido completo de visualización**
    - **Valida: Requisitos 4.1, 4.5**
  
  - [ ]* 8.6 Escribir prueba de propiedad para ordenamiento
    - **Propiedad 10: Ordenamiento por fecha**
    - **Valida: Requisitos 4.2**
  
  - [ ]* 8.7 Escribir prueba de propiedad para URLs clickeables
    - **Propiedad 11: URLs clickeables**
    - **Valida: Requisitos 4.4**
  
  - [ ]* 8.8 Escribir pruebas unitarias para CLI
    - Probar parsing de argumentos
    - Probar manejo de comandos inválidos
    - Probar salida formateada
    - _Requisitos: 4.1, 4.2, 4.3_

- [ ] 9. Implementar punto de entrada principal y configuración
  - [ ] 9.1 Crear archivo __main__.py
  ...
  - [ ] 9.3 Agregar documentación README
...
- [ ] 10. Pruebas de integración end-to-end
  - [ ]* 10.1 Escribir prueba de integración para flujo completo
    - Simular fetch → store → retrieve → display
    - Usar mocks para API
    - Usar base de datos en memoria
    - _Requisitos: 1.1, 2.2, 3.3, 4.1_
  
  - [ ]* 10.2 Escribir prueba de integración para manejo de errores
